...
def load(sess: tf.compat.v1.Session, saver: tf.compat.v1.train.Saver, checkpoint_dir: str) -> bool:
...
def run_batches(sess: tf.compat.v1.Session, tensors_dict_ops: Mapping[str, tf.Tensor],
...
def run_epoch(sess: tf.compat.v1.Session, tensors_dict_ops: Mapping[str, tf.Tensor],
