...
Please find a [Sphinx Documentation](http://htmlpreview.github.com/sphinx/_build/html/index.html) for this repository, which for now contains only the code of the CNN Architecture Team.
